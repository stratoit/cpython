...
#define _loop0_53_type 1214
#define _loop0_54_type 1215
#define _loop0_55_type 1216
#define _loop1_56_type 1217
#define _loop0_57_type 1218
#define _loop1_58_type 1219
#define _loop1_59_type 1220
#define _loop1_60_type 1221
#define _loop0_61_type 1222
#define _loop1_62_type 1223
#define _loop0_63_type 1224
#define _loop1_64_type 1225
#define _loop0_65_type 1226
#define _loop1_66_type 1227
#define _loop1_67_type 1228
#define _tmp_68_type 1229
#define _loop1_69_type 1230
#define _loop0_71_type 1231
#define _gather_70_type 1232
#define _loop1_72_type 1233
#define _loop0_73_type 1234
#define _loop0_74_type 1235
#define _loop0_75_type 1236
#define _loop1_76_type 1237
#define _loop0_77_type 1238
#define _loop1_78_type 1239
#define _loop1_79_type 1240
#define _loop1_80_type 1241
#define _loop0_81_type 1242
#define _loop1_82_type 1243
#define _loop0_83_type 1244
#define _loop1_84_type 1245
#define _loop0_85_type 1246
#define _loop1_86_type 1247
#define _loop1_87_type 1248
#define _loop1_88_type 1249
#define _loop1_89_type 1250
#define _tmp_90_type 1251
#define _loop0_92_type 1252
#define _gather_91_type 1253
#define _tmp_93_type 1254
#define _tmp_94_type 1255
#define _tmp_95_type 1256
#define _tmp_96_type 1257
#define _loop1_97_type 1258
#define _tmp_98_type 1259
#define _tmp_99_type 1260
#define _loop0_101_type 1261
#define _gather_100_type 1262
#define _loop1_102_type 1263
#define _loop0_103_type 1264
#define _loop0_104_type 1265
#define _loop0_106_type 1266
#define _gather_105_type 1267
#define _tmp_107_type 1268
#define _loop0_109_type 1269
#define _gather_108_type 1270
#define _loop0_111_type 1271
#define _gather_110_type 1272
...
#define _loop1_119_type 1280
#define _tmp_120_type 1281
#define _loop0_122_type 1282
#define _gather_121_type 1283
#define _loop0_124_type 1284
#define _gather_123_type 1285
#define _tmp_125_type 1286
#define _loop0_126_type 1287
#define _loop0_127_type 1288
#define _loop0_128_type 1289
#define _tmp_129_type 1290
#define _tmp_130_type 1291
...
func_type_comment_rule(Parser *p)
{
    ...
    { // NEWLINE TYPE_COMMENT &(NEWLINE)
        ...
        if (
            ...
            &&
            _PyPegen_lookahead_with_int(1, _PyPegen_expect_token, p, NEWLINE)  // token=(NEWLINE)
        )
        {
        ...
        D(fprintf(stderr, "%*c%s func_type_comment[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "NEWLINE TYPE_COMMENT &(NEWLINE)"));
    }
...
block_rule(Parser *p)
{
    ...
    { // NEWLINE?? '{' statements '}' NEWLINE
        ...
        Token * newline_var;
        if (
            (_opt_var = _PyPegen_expect_token(p, NEWLINE), 1)  // NEWLINE??
            &&
...
star_expressions_rule(Parser *p)
{
    ...
    { // star_expression ((',' star_expression))+ ','?
        ...
        if (
            ...
            &&
            (b = _loop1_69_rule(p))  // ((',' star_expression))+
            &&
            (_opt_var = _PyPegen_expect_token(p, 12), 1)  // ','?
        )
        {
...
star_named_expressions_rule(Parser *p)
{
    ...
    { // ','.star_named_expression+ ','?
        ...
        asdl_seq * a;
        if (
            (a = _gather_70_rule(p))  // ','.star_named_expression+
            &&
            (_opt_var = _PyPegen_expect_token(p, 12), 1)  // ','?
        )
        {
...
lambda_parameters_rule(Parser *p)
{
    ...
    { // lambda_slash_no_default lambda_param_no_default* lambda_param_with_default* lambda_star_etc?
        ...
        if (
            ...
            &&
            (b = _loop0_73_rule(p))  // lambda_param_no_default*
            &&
    ...
    { // lambda_param_no_default+ lambda_param_with_default* lambda_star_etc?
        ...
        void *c;
        if (
            (a = _loop1_76_rule(p))  // lambda_param_no_default+
            &&
    ...
    { // lambda_param_with_default+ lambda_star_etc?
        ...
        void *b;
        if (
            (a = _loop1_78_rule(p))  // lambda_param_with_default+
            &&
...
lambda_slash_with_default_rule(Parser *p)
{
    ...
    { // lambda_param_no_default* lambda_param_with_default+ '/' ','
        ...
        asdl_seq * b;
        if (
            (a = _loop0_81_rule(p))  // lambda_param_no_default*
            &&
            (b = _loop1_82_rule(p))  // lambda_param_with_default+
            &&
            (_literal = _PyPegen_expect_token(p, 17))  // token='/'
            &&
            (_literal_1 = _PyPegen_expect_token(p, 12))  // token=','
...
lambda_star_etc_rule(Parser *p)
{
    ...
    { // '*' lambda_param_no_default lambda_param_maybe_default* lambda_kwds?
        ...
        if (
            ...
            &&
            (b = _loop0_85_rule(p))  // lambda_param_maybe_default*
            &&
    ...
    { // '*' ',' lambda_param_maybe_default+ lambda_kwds?
        ...
        if (
            ...
            (_literal_1 = _PyPegen_expect_token(p, 12))  // token=','
            &&
            (b = _loop1_86_rule(p))  // lambda_param_maybe_default+
            &&
            (c = lambda_kwds_rule(p), 1)  // lambda_kwds?
        )
        {
...
tuple_rule(Parser *p)
{
    ...
    { // '(' [star_named_expression ',' star_named_expressions?] ')'
        ...
        if (
            (_literal = _PyPegen_expect_token(p, 7))  // token='('
            &&
            (a = _tmp_98_rule(p), 1)  // [star_named_expression ',' star_named_expressions?]
            &&
            (_literal_1 = _PyPegen_expect_token(p, 8))  // token=')'
        )
        {
...
group_rule(Parser *p)
{
    ...
    { // '(' (yield_expr | named_expression) ')'
        ...
        if (
            (_literal = _PyPegen_expect_token(p, 7))  // token='('
            &&
            (a = _tmp_99_rule(p))  // yield_expr | named_expression
            &&
            (_literal_1 = _PyPegen_expect_token(p, 8))  // token=')'
        )
        {
...
double_starred_kvpairs_rule(Parser *p)
{
    ...
    { // ','.double_starred_kvpair+ ','?
        ...
        asdl_seq * a;
        if (
            (a = _gather_100_rule(p))  // ','.double_starred_kvpair+
            &&
            (_opt_var = _PyPegen_expect_token(p, 12), 1)  // ','?
        )
        {
...
for_if_clauses_rule(Parser *p)
{
    ...
    { // for_if_clause+
        ...
        asdl_seq * _loop1_102_var;
        if (
            (_loop1_102_var = _loop1_102_rule(p))  // for_if_clause+
        )
        {
...
for_if_clause_rule(Parser *p)
{
    ...
    { // ASYNC 'for' star_targets 'in' ~ disjunction (('if' disjunction))*
        ...
        if (
            ...
            (b = disjunction_rule(p))  // disjunction
            &&
            (c = _loop0_103_rule(p))  // (('if' disjunction))*
        )
        {
...
args_rule(Parser *p)
{
    ...
    { // ','.(starred_expression | named_expression !'=')+ [',' kwargs]
        ...
        void *b;
        if (
            (a = _gather_105_rule(p))  // ','.(starred_expression | named_expression !'=')+
            &&
            (b = _tmp_107_rule(p), 1)  // [',' kwargs]
        )
        {
...
kwargs_rule(Parser *p)
{
    ...
    { // ','.kwarg_or_starred+ ',' ','.kwarg_or_double_starred+
        ...
        asdl_seq * b;
        if (
            (a = _gather_108_rule(p))  // ','.kwarg_or_starred+
            &&
            (_literal = _PyPegen_expect_token(p, 12))  // token=','
            &&
            (b = _gather_110_rule(p))  // ','.kwarg_or_double_starred+
        )
        {
    ...
    { // ','.kwarg_or_starred+
        ...
        if (
            (_gather_112_var = _gather_112_rule(p))  // ','.kwarg_or_starred+
        )
        {
            D(fprintf(stderr, "%*c+ kwargs[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "','.kwarg_or_starred+"));
            _res = _gather_112_var;
            goto done;
        }
        p->mark = _mark;
        D(fprintf(stderr, "%*c%s kwargs[%d-%d]: %s failed!\n", p->level, ' ',
    ...
    { // ','.kwarg_or_double_starred+
        ...
        if (
            (_gather_114_var = _gather_114_rule(p))  // ','.kwarg_or_double_starred+
        )
        {
            D(fprintf(stderr, "%*c+ kwargs[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "','.kwarg_or_double_starred+"));
...
star_targets_rule(Parser *p)
{
    ...
    { // star_target ((',' star_target))* ','?
        ...
        if (
            (a = star_target_rule(p))  // star_target
            &&
            (b = _loop0_116_rule(p))  // ((',' star_target))*
            &&
            (_opt_var = _PyPegen_expect_token(p, 12), 1)  // ','?
        )
        {
...
star_targets_list_seq_rule(Parser *p)
{
    ...
    { // ','.star_target+ ','?
        ...
        asdl_seq * a;
        if (
            (a = _gather_117_rule(p))  // ','.star_target+
            &&
            (_opt_var = _PyPegen_expect_token(p, 12), 1)  // ','?
        )
        {
...
star_targets_tuple_seq_rule(Parser *p)
{
    ...
    { // star_target ((',' star_target))+ ','?
        ...
        if (
            (a = star_target_rule(p))  // star_target
            &&
            (b = _loop1_119_rule(p))  // ((',' star_target))+
            &&
            (_opt_var = _PyPegen_expect_token(p, 12), 1)  // ','?
        )
        {
...
invalid_double_type_comments_rule(Parser *p)
{
    ...
    void * _res = NULL;
    int _mark = p->mark;
    { // TYPE_COMMENT NEWLINE TYPE_COMMENT NEWLINE
        if (p->error_indicator) {
            D(p->level--);
            return NULL;
        }
        D(fprintf(stderr, "%*c> invalid_double_type_comments[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "TYPE_COMMENT NEWLINE TYPE_COMMENT NEWLINE"));
        Token * newline_var;
        Token * newline_var_1;
        Token * type_comment_var;
        ...
        D(fprintf(stderr, "%*c%s invalid_double_type_comments[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "TYPE_COMMENT NEWLINE TYPE_COMMENT NEWLINE"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
// _loop0_71: ',' star_named_expression
static asdl_seq *
...
// _gather_70: star_named_expression _loop0_71
static asdl_seq *
_gather_70_rule(Parser *p)
{
    ...
    asdl_seq * _res = NULL;
    int _mark = p->mark;
    { // star_named_expression _loop0_71
        if (p->error_indicator) {
            D(p->level--);
            return NULL;
        }
        D(fprintf(stderr, "%*c> _gather_70[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "star_named_expression _loop0_71"));
        expr_ty elem;
        asdl_seq * seq;
        if (
            (elem = star_named_expression_rule(p))  // star_named_expression
        ...
        D(fprintf(stderr, "%*c%s _gather_70[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "star_named_expression _loop0_71"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
// _loop0_81: lambda_param_no_default
static asdl_seq *
...
// _loop0_85: lambda_param_maybe_default
static asdl_seq *
...
// _loop1_86: lambda_param_maybe_default
static asdl_seq *
...
_gather_91_rule(Parser *p)
{
    ...
    { // slice _loop0_92
        ...
        D(fprintf(stderr, "%*c> _gather_91[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "slice _loop0_92"));
        expr_ty elem;
        asdl_seq * seq;
        if (
            (elem = slice_rule(p))  // slice
        ...
        D(fprintf(stderr, "%*c%s _gather_91[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "slice _loop0_92"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
_gather_100_rule(Parser *p)
{
    ...
    asdl_seq * _res = NULL;
    int _mark = p->mark;
    { // double_starred_kvpair _loop0_101
        if (p->error_indicator) {
            D(p->level--);
            return NULL;
        }
        D(fprintf(stderr, "%*c> _gather_100[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "double_starred_kvpair _loop0_101"));
        KeyValuePair* elem;
        asdl_seq * seq;
        if (
            (elem = double_starred_kvpair_rule(p))  // double_starred_kvpair
        ...
        D(fprintf(stderr, "%*c%s _gather_100[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "double_starred_kvpair _loop0_101"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
_gather_105_rule(Parser *p)
{
    ...
    asdl_seq * _res = NULL;
    int _mark = p->mark;
    { // (starred_expression | named_expression !'=') _loop0_106
        if (p->error_indicator) {
            D(p->level--);
            return NULL;
        }
        D(fprintf(stderr, "%*c> _gather_105[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "(starred_expression | named_expression !'=') _loop0_106"));
        void *elem;
        asdl_seq * seq;
        if (
            (elem = _tmp_147_rule(p))  // starred_expression | named_expression !'='
        ...
        D(fprintf(stderr, "%*c%s _gather_105[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "(starred_expression | named_expression !'=') _loop0_106"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
_gather_108_rule(Parser *p)
{
    ...
    asdl_seq * _res = NULL;
    int _mark = p->mark;
    { // kwarg_or_starred _loop0_109
        if (p->error_indicator) {
            D(p->level--);
            return NULL;
        }
        D(fprintf(stderr, "%*c> _gather_108[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "kwarg_or_starred _loop0_109"));
        KeywordOrStarred* elem;
        asdl_seq * seq;
        if (
            (elem = kwarg_or_starred_rule(p))  // kwarg_or_starred
        ...
        D(fprintf(stderr, "%*c%s _gather_108[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "kwarg_or_starred _loop0_109"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
_gather_110_rule(Parser *p)
{
    ...
    asdl_seq * _res = NULL;
    int _mark = p->mark;
    { // kwarg_or_double_starred _loop0_111
        if (p->error_indicator) {
            D(p->level--);
            return NULL;
        }
        D(fprintf(stderr, "%*c> _gather_110[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "kwarg_or_double_starred _loop0_111"));
        KeywordOrStarred* elem;
        asdl_seq * seq;
        if (
            (elem = kwarg_or_double_starred_rule(p))  // kwarg_or_double_starred
        ...
        D(fprintf(stderr, "%*c%s _gather_110[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "kwarg_or_double_starred _loop0_111"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
_gather_117_rule(Parser *p)
{
    ...
    asdl_seq * _res = NULL;
    int _mark = p->mark;
    { // star_target _loop0_118
        if (p->error_indicator) {
            D(p->level--);
            return NULL;
        }
        D(fprintf(stderr, "%*c> _gather_117[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "star_target _loop0_118"));
        expr_ty elem;
        asdl_seq * seq;
        if (
            (elem = star_target_rule(p))  // star_target
        ...
        D(fprintf(stderr, "%*c%s _gather_117[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "star_target _loop0_118"));
    }
    _res = NULL;
  done:
    D(p->level--);
